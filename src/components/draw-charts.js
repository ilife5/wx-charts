    ...
    switch (type) {
        ...
        case 'column':
            this.animationInstance = new Animation({
                ...
                onProcess: (process) => {
                    drawYAxis(series, opts, config, context);
                    drawXAxis(categories, opts, config, context);
                    this.chartData.xAxisPoints = drawColumnDataPoints.call(this, series, opts, config, context, process);
                    drawLegend(opts.series, opts, config, context);                    
                    drawCanvas(opts, context);
                },
                onAnimationFinish: () => {
        ...
        case 'area':
            this.animationInstance = new Animation({
                ...
                onProcess: (process) => {
                    drawYAxis(series, opts, config, context);
                    drawXAxis(categories, opts, config, context);
                    this.chartData.xAxisPoints = drawAreaDataPoints.call(this, series, opts, config, context, process);
                    drawLegend(opts.series, opts, config, context);                    
                    drawCanvas(opts, context);
                },
                onAnimationFinish: () => {
        ...
        case 'pie':
            this.animationInstance = new Animation({
                ...
                duration: duration,
                onProcess: (process) => {
                    this.chartData.pieData = drawPieDataPoints.call(this, series, opts, config, context, process);
                    drawLegend(opts.series, opts, config, context);
                    drawCanvas(opts, context);
                },
                onAnimationFinish: () => {
